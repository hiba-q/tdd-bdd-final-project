...
Scenario: Update a Product
    ...
    When I change "Name" to "Bed sheets"
    ...
    And I press the "Retrieve" button
    Then I should see the message "Success"
    And I should see "Bed sheets" in the "Name" field
    When I press the "Clear" button
    And I press the "Search" button
    Then I should see the message "Success"
    And I should see "Bed sheets" in the results
    But I should not see "Sheets" in the results
